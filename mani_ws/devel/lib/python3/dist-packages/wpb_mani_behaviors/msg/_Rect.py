...
"""autogenerated by genpy from wpb_mani_behaviors/Rect.msg. Do not edit."""
import codecs
import sys
...
float64[] probability"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.top))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.top = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%si'%length
